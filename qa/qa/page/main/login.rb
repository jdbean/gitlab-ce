  ...
  module Page
    module Main
      class Login < Page::Base
        ...
        def sign_in_using_credentials(username: nil, password: nil)
          ...
          using_wait_time 0 do
            ...
            if !username && !password && Runtime::User.ldap_user?
              sign_in_using_ldap_credentials
            else
              sign_in_using_gitlab_credentials(username: username, password: password)
            end
          end
        ...
        def sign_in_using_gitlab_credentials(username:, password:)
